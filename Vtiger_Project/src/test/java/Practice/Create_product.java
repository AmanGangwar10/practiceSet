...
//		driver.findElement(By.name("productname")).sendKeys(productData);
		...
		CreateProductPage prodPage1 = new CreateProductPage(driver);
		prodPage1.enterProdName(productData);
		
//		driver.findElement(By.xpath("//input[@title=\"Save [Alt+S]\"]")).click();
		
		CreateProductPage prodPage2 = new CreateProductPage(driver);
		prodPage2.clickOnSaveButton();
